...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\LUNA\Curso HTML\PythonProyect\ManejoHTML'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\LUNA\Curso HTML\PythonProyect\ManejoHTML\Scripts\deactivate.nu'
